...
<body>
    ...
    <div class="movie1" >
        <a href ="trailer/About Fate  trailer.mp4">  <img src="movies/fate.jpg" class="luck" alt="..."> </a>
        <img src="movies/Romance_AboutFate.jpg" class="luck1">     
    ...
    <div class="sypnopsis_luck">
      ...
      <div class="synopsis1_luck">
        <h2 >   The romantic comedy is a tale of two people who believe in love,  but seem to never be able to find its true meaning  In a wild twist of events, fate puts each in the other's path on a stormy 
             <br>  New Year's Eve and comedy and chaos ensue.
            </h2>
      </div>
