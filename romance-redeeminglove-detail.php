...
<body>
    ...
    <div class="movie1" >
        <a href ="trailer/Redeeming Love trailer.mp4">  <img src="movies/rom.jpg" class="luck" alt="..."> </a>
        <img src="movies/Romance_RedeemingLove.jpg" class="luck1">     
    ...
    <div class="sypnopsis_luck">
      ...
      <div class="synopsis1_luck">
        <h2 >  A young couple's relationship clashes with the harsh realities of the California Gold Rush of 1850. Angel, experiencing love for the first time and facing demons that seem unsurmountable, 
            <br>  runs from the new life she doesn't think she deserves.  <br>  
            </h2>
      </div>
