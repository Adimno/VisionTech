...
<div class="movie1" >
    <a href ="trailer/H.P. Lovecraft_s Witch House trailer.mp4"> <img src="movies/house.jpg" class="luck" alt="..."> </a>
    <img src="movies/Horror_H.P.jpg" class="luck1">     
...
<div class="luck_content">
  ...
  <div class="luck_content1">
    <h1 >  H.P. LOVECRAFT'S WITCH HOUSE</h1> 
    <h1 > HORROR </h1>
  </div>
...
<div class="sypnopsis_luck">
  ...
  <div class="synopsis1_luck">
    <h2 >     Determined to prove the possibility of alternate dimensions, a graduate student unknowingly <br>
        unlocks a gateway to unimaginable horror. Based on the H.P. Lovecraft's <br>  short story The Dreams in the Witch House.
        <br>  </h2>
  </div>
